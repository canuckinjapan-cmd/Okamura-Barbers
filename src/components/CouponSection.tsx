...
export default function CouponSection({ onBookWithCoupon }: CouponSectionProps) {
  return (
    <section id="coupon" className="py-14 sm:py-20 md:py-28 bg-neutral-900 border-t border-neutral-950 relative overflow-hidden font-sans scroll-mt-20">
      ...
      <div className="w-full max-w-4xl mx-auto px-4 md:px-6 relative z-10">
        ...
        {/* Section Header */}
        <div className="text-center max-w-2xl mx-auto mb-5 sm:mb-6 md:mb-8">
          <div className="inline-flex items-center gap-2 text-gold-400 mb-2.5 sm:mb-3 bg-neutral-950 border border-neutral-800 px-3 py-1 rounded-full">
          ...
          <h2 className="text-2xl md:text-4xl font-serif font-bold text-white tracking-tight">
            <span className="block sm:inline">ホームページ開設</span><span className="block sm:inline">記念キャンペーン（案）</span>
          </h2>
          <div className="h-0.5 w-12 bg-gradient-to-r from-gold-500 to-gold-700 mx-auto mt-3 sm:mt-4" />
        </div>
        ...
        >
          ...
          <div className="bg-gradient-to-br from-neutral-950 via-neutral-950 to-neutral-900 rounded-[14px] p-4 sm:p-7 md:p-9 relative overflow-hidden">
            ...
            {/* Main Content Layout */}
            <div className="flex flex-col md:flex-row items-center justify-between gap-5 sm:gap-6 md:gap-4 relative z-10">
              
              {/* Coupon details left */}
              <div className="flex-1 text-center md:text-left space-y-2.5 sm:space-y-3.5">
                ...
                <h3 className="text-base sm:text-lg md:text-xl text-neutral-300 font-medium">
                  Webサイトを見てはじめてご来店の方
                </h3>
              ...
              <div className="flex flex-col items-center justify-center p-1 sm:p-2 text-center shrink-0 w-full md:w-64 space-y-2.5 sm:space-y-3.5">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-gold-500 via-gold-400 to-gold-600 hover:from-gold-600 hover:to-gold-700 text-neutral-950 font-bold py-3 sm:py-3.5 px-6 rounded-xl text-xs uppercase tracking-widest transition-all duration-300 shadow-xl shadow-gold-500/10 border-t border-white/20 cursor-pointer flex items-center justify-center gap-2 group"
                  id="coupon-book-btn"
                >
            ...
            <div className="mt-5 sm:mt-7 pt-4 sm:pt-5 border-t border-neutral-800/60 text-[10.5px] sm:text-xs text-neutral-400/90 grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-1.5 leading-relaxed">
              <div className="flex items-start gap-1.5">
                <Info className="w-3.5 h-3.5 text-gold-400/70 shrink-0 mt-0.5" />
                <span>はじめて岡村理容美容館にお越しいただく方への、ささやかな歓迎特典です。</span>
              </div>
              <div className="flex items-start gap-1.5">
                <Info className="w-3.5 h-3.5 text-gold-400/70 shrink-0 mt-0.5" />
                <span>お一人様1回のご利用でお楽しみいただけます。</span>
              </div>
              <div className="flex items-start gap-1.5">
                <Info className="w-3.5 h-3.5 text-gold-400/70 shrink-0 mt-0.5" />
                <span>他のクーポン・割引との併用はご遠慮いただいておりますので、あらかじめご了承くださいませ。</span>
              </div>
              <div className="flex items-start gap-1.5">
                <Info className="w-3.5 h-3.5 text-gold-400/70 shrink-0 mt-0.5" />
                <span>ご来店の際は、このページかご予約完了画面をスタッフにお見せいただくだけでOKです！</span>
              </div>
            </div>
