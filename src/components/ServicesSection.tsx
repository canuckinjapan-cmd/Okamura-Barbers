...
export default function ServicesSection({ onSelectService, services, reviews }: ServicesSectionProps) {
  return (
    <section id="services" className="py-14 sm:py-18 md:py-24 bg-neutral-950 border-t border-neutral-900 overflow-hidden scroll-mt-20">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        
        {/* Section Header */}
        <div className="text-center max-w-5xl mx-auto mb-10 sm:mb-14 md:mb-16">
          ...
          <p className="text-xs text-neutral-500 mt-2 font-sans">
            ※掲載画像はすべてイメージ（イラストレーション）です。メニューおよび料金はご提案用サンプルであり、正式な内容はクライアント様ご提供データに差し替えます。
          </p>
        </div>
        ...
        {reviews && reviews.length > 0 && (
          <div className="mt-20 md:mt-28 pt-16 border-t border-neutral-900 font-sans scroll-mt-20" id="reviews">
            {/* Section Header */}
